...
from .views import (MyTuitionListView,
                     TeacherProfileView,
                       TeacherListView ,
                       CreateTuitionView,
                       TutionUpdateViewSet,
                       TutionApplicationUpdateViewSet,
                        )
...
router.register("tution-applications", TutionApplicationUpdateViewSet, basename="tution_application_update")
